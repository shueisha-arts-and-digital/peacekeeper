...
function getDefaultConfigs() {
  return [
    ...
    },
    {
      ...
      alert: false,
      favicon: false,
      style: "#app > div > div > div > div > div > div > section { background-color: rgba(10,132,255,1) !important; }",
    ...
    },
    {
      ...
      style: "#app > div > div > div > div > div > div > section { background-color: rgba(255,69,58,1) !important; }",
